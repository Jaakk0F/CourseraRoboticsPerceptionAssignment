...
% Initialize the tracker with the initial points
initialize(point_tracker, img_pts_init, images{1}); % point_tracker用第一帧进行初始化

% Iterate through the rest of the images
for i = 2:size(images,1)
    %%%% CODE FOR TRACKING HERE %%%%
    [img_pts, vadility] = step(point_tracker, images{i});
